...
import JobSchemaHelmet from './JobSchemaHelmet';

/**
 * SEO Hook to inject JSON-LD structured data for job postings
...
export const useSeoJobSchema = (
  ...
  React.useEffect(() => {
    ...
    if (pageTitle) {
      ...
      document.title = `${job.title} - JOBS Bangladesh`;
    }
